...
public class FileUtil {
    ...
    static {
        ...
        if(os.equals("LINUX")){
            currentWorkDir = path.substring(0, index);
        }else{
            currentWorkDir = path.substring(1, index);
        }
    }
    ...
    public static boolean workbookWrite(Workbook wb,String file){
    ...
    public static String getDownLoadPath(){
        //String  path = Joiner.on(File.separator).join(currentWorkDir,Const.DEFAULT_BASE_DOWNLOAD_PATH,LocalDateUtil.getLocalDate(),"");
        String path = JFinalExt.DOWNLOAD_PATH + UploadPathKit.getDatePath();
    ...
    public static String getAbsDownLoadPath(){
        return Const.DEFAULT_BASE_DOWNLOAD_PATH + UploadPathKit.getDatePath();
    }
    ...
    public static String getDownLoadPath(String fileName){
        return getDownLoadPath()+File.separator+fileName;
    }
 ...
 /*   public static String getUpLoadPath(String fileName){
        ...
        String path = JFinalExt.UPLOAD_PATH+ UploadPathKit.getDatePath();
        //String path =  Joiner.on(File.separator).join(currentWorkDir,Const.DEFAULT_BASE_UPLOAD_PATH,LocalDateUtil.getLocalDate(),"");
        File f = new File(path);
        if(!f.exists()){
            f.mkdirs();
        }
    ...
    public static String getModelPath(String fileName){
        String path =  Joiner.on(File.separator).join(currentWorkDir,MODEL_PATH,"");
        File f = new File(path);
        if(!f.exists()){
            f.mkdirs();
        }
    ...
    public static void main(String[] args) {
       ...
       /* File f= new File("/home/sam/IdeaProjects/esr/tracker/target/tracker-1.0/download/2017-06-09/");

        boolean b = f.mkdir();
        System.out.println(b);*/

        String s= PathKit.getRootClassPath();

        String ss = "/home/sam/33.txt";
        String tag = "/home/sam/44.txt";
        File f = new File(ss);

        boolean b = f.renameTo(new File(tag));
